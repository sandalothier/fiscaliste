...
public class ErecetteKafkaResourceIT {
    ...
    @Autowired
    private ErecetteKafkaProducer producer;

    @Autowired
    private ErecetteKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        ErecetteKafkaResource kafkaResource = new ErecetteKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/erecette-kafka/publish?message=test"))
